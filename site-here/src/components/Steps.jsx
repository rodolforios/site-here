            ...
            <div className="grid gap-8 row-gap-0 lg:grid-cols-4">
                ...
                <div className="relative text-center">
                    <Fade bottom>
                        ...
                        <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
                            Nesta etapa, todo treinamento será feito com a equipe do cliente, para ensinar a utilizar o software conforme o esperado, e após todo o treinamento, a publicação do mesmo nas plataformas desejadas.
                        </p>
                    </Fade>
                </div>
